            ...
            <div className='flex justify-between '>
                <div className='flex flex-col justify-center '>
                    <div className='bg-white'>
                        <img src={`data:image/png;base64,${imageB64}`} alt='Logo du ministere' className='w-14 h-14' />
