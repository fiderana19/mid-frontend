    ...
    return (
        <div className='min-h-screen flex flex-col justify-center'>
            <div className='sm:flex block justify-between'>
                ...
                <div className='lg:w-1/3 sm:w-1/2 w-full bg-primary-custom h-screen text-center py-5 sm:px-10 px-4 flex flex-col justify-center'>
                    <div className='text-2xl font-semibold mb-10'>Connexion à votre compte</div>
                    <form onSubmit={loginSubmit(handleLoginUser)}>
                        <div className='w-64 mx-auto'>
                            ...
                            <Button variant={'secondary'} size={'lg'} disabled={isSubmitting } className={`${isSubmitting && 'cursor-not-allowed'} w-full mt-4`} type='submit'>{ isSubmitting && <LoadingOutlined /> }  SE CONNECTER</Button>
                        </div>
                    </form>
